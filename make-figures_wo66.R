...
ggsave(plot = plot_res_e2, filename = "figures/res-e2_v2.pdf", device = "pdf",
...
ggsave(plot = plot_res_e3, filename = "figures/res-e3_v2.pdf", device = "pdf",
...
plot_res_out <- plot_grid(pr1use, pr2use, pr1use_e3, pr2use_e3, 
                          ncol = 1, align = "hv", 
                          labels =  c("(a) Exp. 2", "(b) Exp. 2", 
                                      "(c) Exp. 3", "(d) Exp. 3"), 
                          hjust = -0.07,
                          rel_heights = c(3, 2, 2, 1) + 1.25)

ggsave(plot = plot_res_out, filename = "figures/main-res_v2.pdf", 
       device = "pdf",
